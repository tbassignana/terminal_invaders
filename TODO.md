...
- [ ] **Step 27:** Add explosion particles on alien death (5-8 particles, directional spread)
...
- [ ] **Step 32:** Add starfield background (dim scrolling parallax stars)
- [ ] **Step 33:** Add color-per-alien-type rendering (cyan/magenta/yellow + bold in frenzy mode)
